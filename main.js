...
outEl.innerHTML += "<h2> Manufacturing Businesses"
...
const agentsFullInfo = businesses.map(business => {
    return {
        "full_name" : `${business.purchasingAgent.nameFirst} ${business.purchasingAgent.nameLast}`,
        "company" : `${business.companyName}`,
        "phoneNumber" : `${business.phoneWork}`
    }
})

outEl.innerHTML += "<h1>Purchasing Agents Detail Information</h1>";
agentsFullInfo.forEach(business =>{
    outEl.innerHTML += `
    <h2> ${business.full_name} </h2>
    <h3> ${business.company}</h3>
    <h3> ${business.phoneNumber} </h3>`
})
